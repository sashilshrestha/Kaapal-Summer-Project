    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Alerts -->
                <span class="badge badge-danger badge-counter <?php echo $num == 0 ? 'd-none' : ''; ?>"><?php echo $num; ?>+</span>
            </a>
            <!-- Dropdown - Alerts -->
        ...
        $ret = mysqli_query($con, "select AdminName,UserName from tbladmin where ID='$adid'");
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="../admin/img/admin/<?php echo $row["UserName"]; ?>.jpg" style="object-fit: cover;object-position: center center;" />
            </a>

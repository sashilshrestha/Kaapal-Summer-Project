                            ...
                            <form method="post" class="user">
                                ...
                                ?>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="name" name="name" value="<?php echo $row['Name']; ?>" required>
                                    </div>
                                    <div class="form-group mb-4">
                                        <p class="m-0 pl-2">Email <i class="ml-1 fas fa-caret-down"></i></p>
                                        <input type="text" class="form-control form-control-user" id="email" name="email" value="<?php echo $row['Email']; ?>" required>
                                    </div>
                                    <div class="form-group mb-4">
                                        <p class="m-0 pl-2">Mobile Number <i class="ml-1 fas fa-caret-down"></i></p>
                                        <input type="text" class="form-control form-control-user" id="mobilenum" name="mobilenum" value="<?php echo $row['MobileNumber']; ?>" required>
                                    </div>
                                    <p>

                                    <p class="pl-2 my-2">Gender <i class="ml-1 fas fa-caret-down"></i></p>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" id="details" name="details"><?php echo $row['Details']; ?></textarea>
                                    </div>
                                <?php } ?>
                                <input type="submit" name="submit" value="Update Customer Information" class="btn bg-primary text-white btn-user btn-block mt-5">
                            </form>
                        </div>
                    </div>
